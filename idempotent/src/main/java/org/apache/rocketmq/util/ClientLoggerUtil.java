...
public class ClientLoggerUtil {
    ...
    private static final String CLIENT_LOG_FILEMAXINDEX = "rocketmq.client.logFileMaxIndex";
    private static final String CLIENT_LOG_LEVEL = "rocketmq.client.logLevel";
